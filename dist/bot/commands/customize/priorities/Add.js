...
exports.default = (0, createCommand_1.createCommand)({
    name: 'adicionar',
    description: 'Adicione um cargo de prioridade de fila dos confrontos (prioriza alguns jogadores)',
    type: 'command',
    args: {
        role: {
            name: 'cargo',
        ...
        priority: {
            ...
            description: 'Prioridade de fila',
            required: true,
        },
    },
    run: async (ctx) => {
        ...
        const priority = ctx.args.priority;
        ...
        ctx.data.reply({
            content: 'Cargo de prioridade adicionado!',
            embeds: [
                new Embed_1.Embed()
                    .setDescription(`> Novo cargo: <@&${role}>\n> Prioridade: ${priority}`)
                    .setColorHex('#ff4343'),
            ],
            flags: 64,
        });
